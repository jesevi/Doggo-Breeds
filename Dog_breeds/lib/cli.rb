class CLI
    ...
    def greeting
        ...
        puts ""
        puts "When you are done type 'exit' and hope you have a great day!"
    end   
    ...
    def goodbye
        puts "Goodbye! dont forget to give your dog a treat and go out for your daily walk!"
    end 
    ...
    def breed_selection(breed)
        ...
        if breed
            ...
            puts "If you are done here, type 'exit'."
            puts ""
            puts "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
            menu
        else
    ...
    def incorrect_breed_name
        puts "Ruh Roh. The breed name that you entered may have been spelled incorrectly."
